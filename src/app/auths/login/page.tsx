    ...
    <div className="relative min-h-screen flex items-center justify-center bg-white">
      ...
      <div className="bg-[#6984D4] bg-opacity-20 text-white translate-y-11 rounded-md px-[5%] py-[10%] shadow-lg">
        <form
          ...
          className="relative z-10 flex flex-col items-center text-white space-y-4"
        >
          ...
          <div className="relative w-[320px]">
            ...
            <Image
              ...
              width={20}
              height={20}
              className="absolute left-4 top-1/2 -translate-y-1/1"
            />
            <span
              className="absolute right-4 top-1/2 -translate-y-1/1 cursor-pointer text-black text-xl"
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-[#252525] text-[#7994BC] rounded-md px-12 py-3 shadow-lg cursor-pointer text-[20px] font-semibold"
            >
              LOGIN
            </button>
